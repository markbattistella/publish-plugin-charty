...
public struct ChartSeries: Decodable, Sendable {
	...
	internal init(label: String, values: [Double], isScalar: Bool = false, colour: String? = nil, points: [String]? = nil) {
		self.label = label
		self.values = values
...
public struct ChartSpec: Decodable, Sendable {
	...
	public init(from decoder: Decoder) throws {
		...
		self.options = try container.decodeIfPresent(ChartOptions.self, forKey: .options)
			?? ChartOptions()
